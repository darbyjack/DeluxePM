package me.glaremasters.deluxepm.commands.base;
...
import me.glaremasters.deluxepm.util.ConfirmAction;
import me.glaremasters.deluxepm.util.IHandler;
...
public class CommandHandler implements CommandExecutor, TabCompleter, IHandler {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel,
        ...
        if (!cmd.getName().equalsIgnoreCase("deluxepm")) {
            return true;
        }
